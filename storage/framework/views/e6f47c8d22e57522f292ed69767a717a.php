...
<div class="container mx-auto p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center">
            <h1 class="text-2xl font-semibold text-[var(--primary-color)]">Crear Cliente</h1>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="document_number" id="document_number" value="<?php echo e(old('document_number')); ?>"
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="birthdays" id="birthdays" value="<?php echo e(old('birthdays')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                            placeholder="Observaciones o notas adicionales sobre el cliente"><?php echo e(old('notes')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\laravel_clary\restaurant_app\resources\views/clients/create.blade.php ENDPATH**/ ?>