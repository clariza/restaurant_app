...
<div class="container mx-auto p-6">
    ...
    <form action="<?php echo e(route('suppliers.store')); ?>" method="POST" class="bg-white rounded-lg shadow-md p-6">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nit" id="nit" 
                   class="mt-1 block w-full px-3 py-2 border border-[var(--tertiary-color)] rounded-md shadow-sm focus:outline-none focus:ring-[var(--primary-color)] focus:border-[var(--primary-color)] sm:text-sm" 
                   value="<?php echo e(old('nit')); ?>" required>
            <?php $__errorArgs = ['nit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
        ...
        <!-- Dirección (ahora antes de contacto) -->
        <div class="mb-4">
            ...
            <textarea name="address" id="address" rows="2"
                      ...
                      placeholder="Ingrese la dirección completa del proveedor" required><?php echo e(old('address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <textarea name="notes" id="notes" rows="4"
                      class="mt-1 block w-full px-3 py-2 border border-[var(--tertiary-color)] rounded-md shadow-sm focus:outline-none focus:ring-[var(--primary-color)] focus:border-[var(--primary-color)] sm:text-sm resize-vertical" 
                      placeholder="Agregue cualquier información adicional sobre el proveedor (términos de pago, observaciones, etc.)"><?php echo e(old('notes')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Desktop\laravel\repo\restaurant_app\resources\views/suppliers/create.blade.php ENDPATH**/ ?>