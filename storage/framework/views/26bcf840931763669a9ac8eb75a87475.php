...
<div class="container mx-auto p-6">
    ...
    <div class="mb-6">
        ...
        <div class="flex items-center gap-2 text-sm text-[var(--text-light)]">
            ...
            <span>Referencia: <strong><?php echo e($purchase->reference_number ?? 'N/A'); ?></strong> | Estado: <strong class="text-yellow-600"><?php echo e(ucfirst($purchase->status)); ?></strong></span>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <select id="proveedor" name="supplier_id" 
                        ...
                        <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($supplier->id); ?>" 
                                    data-nit="<?php echo e($supplier->nit); ?>" 
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nit" name="supplier_nit"
                           value="<?php echo e($purchase->supplier->nit ?? ''); ?>"
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="numeroReferencia" name="reference_number" 
                           value="<?php echo e($purchase->reference_number); ?>"
                           class="w-full border-2 border-[var(--gray-light)] rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[var(--primary-color)] transition-colors"
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" id="fechaCompra" name="purchase_date" 
                           value="<?php echo e($purchase->purchase_date->format('Y-m-d\TH:i')); ?>" 
                           class="w-full border-2 border-[var(--gray-light)] rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[var(--primary-color)] transition-colors" 
                           required>
                </div>
                ...
                <div class="form-group col-span-2">
                    ...
                    <input type="text" id="supplier-address" name="supplier_address"
                           value="<?php echo e($purchase->supplier->address ?? ''); ?>"
                           class="w-full border-2 border-[var(--gray-light)] rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[var(--primary-color)] transition-colors"
            ...
            <div class="overflow-x-auto rounded-lg border-2 border-[var(--gray-light)]">
                <table class="w-full border-collapse text-xs">
                    ...
                    <tbody id="products-table-body" class="divide-y divide-[var(--gray-light)]">
                        ...
                        <?php $__currentLoopData = $purchase->stocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            <td class="px-3 py-3 border-r border-[var(--gray-light)]">
                                <div class="font-medium text-[var(--text-color)]"><?php echo e($stock->item->name ?? 'Producto eliminado'); ?></div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <i class="fas fa-tag mr-1"></i><?php echo e($stock->item->category->name ?? 'Sin categoría'); ?>

                                </div>
                                <input type="hidden" name="products[<?php echo e($index); ?>][product_id]" value="<?php echo e($stock->product_id); ?>">
                                <input type="hidden" name="products[<?php echo e($index); ?>][stock_id]" value="<?php echo e($stock->id); ?>">
                            </td>
                            <td class="px-3 py-3 text-center border-r border-[var(--gray-light)]">
                                <input type="number" name="products[<?php echo e($index); ?>][quantity]" value="<?php echo e($stock->quantity); ?>" min="1" 
                            ...
                            <td class="px-3 py-3 text-center border-r border-[var(--gray-light)]">
                                <input type="number" name="products[<?php echo e($index); ?>][unit_cost]" value="<?php echo e($stock->unit_cost); ?>"
                            ...
                            <td class="px-3 py-3 text-center border-r border-[var(--gray-light)]">
                                <div class="flex items-center justify-center gap-1">
                                    <input type="number" name="products[<?php echo e($index); ?>][discount]" value="<?php echo e($stock->discount); ?>"
                            ...
                            <td class="px-3 py-3 text-center border-r border-[var(--gray-light)]">
                                <!-- AHORA EDITABLE -->
                                <input type="number" name="products[<?php echo e($index); ?>][unit_cost_after_discount]"
                                       ...
                                       value="<?php echo e(number_format($stock->unit_cost * (1 - $stock->discount / 100), 2)); ?>"
                                       step="0.01" min="0">
                            </td>
                            <td class="px-3 py-3 text-center border-r border-[var(--gray-light)]">
                                <!-- AHORA EDITABLE -->
                                <input type="number" name="products[<?php echo e($index); ?>][line_total]"
                                       ...
                                       value="<?php echo e(number_format($stock->total_cost, 2)); ?>"
                                       step="0.01" min="0">
                            </td>
                            <td class="px-3 py-3 text-center border-r border-[var(--gray-light)]">
                                <!-- AHORA EDITABLE -->
                                <input type="number" name="products[<?php echo e($index); ?>][profit_margin]"
                                       ...
                                       value="<?php echo e(number_format($stock->profit_margin, 2)); ?>"
                                       step="0.01" min="-100" max="1000">
                                <div class="profit-margin-display font-semibold text-xs mt-1 px-2 py-0.5 rounded" style="color: <?php echo e($stock->profit_margin >= 30 ? '#28a745' : ($stock->profit_margin >= 15 ? '#ffc107' : '#dc3545')); ?>; background-color: <?php echo e($stock->profit_margin >= 30 ? '#d4edda' : ($stock->profit_margin >= 15 ? '#fff3cd' : '#f8d7da')); ?>;">
                                    <?php echo e(number_format($stock->profit_margin, 2)); ?>%
                                </div>
                            </td>
                            <td class="px-3 py-3 text-center border-r border-[var(--gray-light)]">
                                <input type="number" name="products[<?php echo e($index); ?>][selling_price]" value="<?php echo e($stock->selling_price); ?>"
                            ...
                            <td class="px-3 py-3 text-center border-r border-[var(--gray-light)]">
                                <input type="date" name="products[<?php echo e($index); ?>][expiry_date]" 
                                       value="<?php echo e($stock->expiry_date ? $stock->expiry_date->format('Y-m-d') : ''); ?>"
                ...
                <div class="flex justify-end space-x-8 text-sm text-[var(--text-color)] font-semibold items-center">
                    <div class="flex items-center space-x-2">
                        ...
                        <input type="number" id="total-products-input" name="total_products" 
                               value="<?php echo e($purchase->stocks->count()); ?>" min="0"
                        ...
                        <span id="total-products" class="font-bold text-[var(--primary-color)] text-lg">(<?php echo e($purchase->stocks->count()); ?>)</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        ...
                        <input type="number" id="total-amount-input" name="total_amount"
                               value="<?php echo e(number_format($purchase->total_amount, 2, '.', '')); ?>" min="0" step="0.01"
                        ...
                        <span id="total-amount" class="font-bold text-green-600 text-lg">(Bs. <?php echo e(number_format($purchase->total_amount, 2)); ?>)</span>
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    let productRowCounter = <?php echo e($purchase->stocks->count()); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Desktop\laravel\repo\restaurant_app\resources\views/purchases/edit.blade.php ENDPATH**/ ?>