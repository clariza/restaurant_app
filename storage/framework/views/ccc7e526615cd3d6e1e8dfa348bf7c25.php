...
(async function() {
    try {
        ...
        const fallbackValue = <?php echo e($settings->tables_enabled ? 'true' : 'false'); ?>;
...
@media (max-width: 480px) {
    ...
    </style><?php /**PATH C:\Users\User\Documents\laravel_clary\restaurant_app\resources\views/partials/payment-modal.blade.php ENDPATH**/ ?>