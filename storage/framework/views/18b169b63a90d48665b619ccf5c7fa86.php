...
<div class="container mx-auto p-6">
   ...
   <div class="mb-6">
    ...
    <form action="<?php echo e(route('purchases.store')); ?>" method="POST" id="purchase-form" class="bg-white shadow-md rounded-lg overflow-hidden border border-[var(--gray-light)] p-6">
    <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            ...
            <div>
                ...
                <div class="flex items-center border border-[var(--gray-light)] rounded text-[var(--text-color)] text-sm">
                    ...
                    <a href="<?php echo e(route('suppliers.create')); ?>" class="ml-2 mr-1 text-[var(--blue)] hover:text-[var(--primary-light)] focus:outline-none transition duration-200">
        ...
        <div class="border border-[var(--primary-color)] rounded-md p-4 mb-6">
            <div class="flex flex-col md:flex-row items-center md:items-stretch justify-between gap-4 mb-4">
                ...
                <a href="<?php echo e(route('items.create')); ?>" class="text-[var(--primary-color)] hover:text-[var(--primary-light)] text-sm font-normal flex items-center space-x-1 transition duration-200">
    ...
    <button type="button" id="add-product-btn" 
        ...
        <div class="flex justify-end space-x-4">
            <a href="<?php echo e(route('purchases.index')); ?>" class="bg-[var(--gray-light)] hover:bg-gray-300 text-[var(--text-color)] px-6 py-2 rounded-lg transition duration-200">
                Cancelar
            </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\laravel_clary\restaurant_app\resources\views/purchases/create.blade.php ENDPATH**/ ?>