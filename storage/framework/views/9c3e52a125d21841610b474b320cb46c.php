...
<body>
    ...
    <?php endif; ?>">
    <?php echo e($order->order_type === 'Comer aquí' ? 'Para la Mesa' : $order->order_type); ?>
            ...
            <table class="items-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Bs. <?php echo e(number_format($item->price, 2)); ?></td>
                        <td>Bs. <?php echo e(number_format($item->quantity * $item->price, 2)); ?></td>
                    </tr>
        ...
        <div class="totals-section">
            <div class="totals">
                <div class="total-row subtotal">
                    <span>Subtotal</span>
                    <span>Bs. <?php echo e(number_format($order->subtotal, 2)); ?></span>
                </div>
                
                <?php if($order->tax > 0): ?>
                <div class="total-row">
                    <span>Impuesto (<?php echo e(config('restaurant.tax_rate', 13)); ?>%)</span>
                    <span>Bs. <?php echo e(number_format($order->tax, 2)); ?></span>
                </div>
                <?php endif; ?>
                ...
                <div class="total-row">
                    <span>Descuento</span>
                    <span>-Bs. <?php echo e(number_format($order->discount, 2)); ?></span>
                </div>
                <?php endif; ?>
