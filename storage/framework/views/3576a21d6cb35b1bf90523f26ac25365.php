...
<!-- <div class="mb-4">
    ...
    <div id="orders-container" class="hidden transition-all duration-300 ease-in-out">
        ...
        <div class="orders-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            ...
            foreach ($__currentLoopData as $order): $__env->incrementLoopIndices();
            ...
            <?php if ($category->menuItems->count() > 0): ?>
                <div id="category-<?php echo e($category->id); ?>" class="mb-8" style="display: none;">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        <?php $__currentLoopData = $category->menuItems;
                        $__env->addLoop($__currentLoopData);
...
<style>
    ...
    .filter-btn {
        @apply px-4 py-2 rounded-lg bg-white text-[var(--primary-color)] font-medium border border-[var(--tertiary-color)] hover:bg-[var(--primary-color)] hover:text-white transition-colors flex items-center;
    }
    ...
    .order-card {
        ...
        /* Borde sutil para todas las tarjetas */
    }
    ...
    .filter-dine-in {
        ...
        /* Amarillo/naranja vibrante */
    }

    .filter-take-away {
        background-color: #2EC4B6;
        /* Verde azulado fresco */
    }
    ...
    .category-btn {
        @apply flex flex-col items-center p-4 border rounded-lg bg-white text-[var(--primary-color)] hover:bg-[var(--primary-color)] hover:text-white transition-colors;
    }
    ...
    .add-btn {
        @apply bg-[var(--primary-color)] text-white px-4 py-2 rounded-lg hover:bg-[var(--primary-light)] transition-colors text-sm sm:text-base;
    }
    ...
    .search-input {
        @apply border rounded-lg bg-gray-200 py-2 pl-2 pr-4 w-full md:w-64 text-gray-700 focus:outline-none focus:bg-white focus:shadow-md;
    }
    ...
    #item-modal-content button:hover {
        color: #374151;
        /* Color gris más oscuro al hacer hover */
    }
