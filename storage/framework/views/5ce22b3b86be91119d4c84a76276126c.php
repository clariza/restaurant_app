            ...
            <div class="flex items-center">
                ...
                <h1 class="text-3xl font-bold text-gray-800 flex items-center">
                    ...
                    <span class="ml-2 inline-flex items-center px-3 py-1 rounded-full text-sm font-medium 
                                <?php echo e($branch->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
        ...
        <div class="lg:col-span-2">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-900 font-mono"><?php echo e($branch->code); ?></p>
                    </div>
                    
                    <div>
                        <label class="block text-sm font-medium text-gray-500 mb-1">Nombre</label>
                        <p class="text-lg font-semibold text-gray-900"><?php echo e($branch->name); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
                ...
                <div class="space-y-4">
                    <?php if($branch->address): ?>
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900"><?php echo e($branch->address); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>

                    <?php if($branch->ciudad || $branch->departamento): ?>
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900">
                                    <?php echo e($branch->ciudad); ?><?php if($branch->ciudad && $branch->departamento): ?>, <?php endif; ?><?php echo e($branch->departamento); ?>
                    ...
                    <?php if(!$branch->address && !$branch->ciudad && !$branch->departamento): ?>
                    ...
                    <?php if($branch->phone): ?>
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900"><?php echo e($branch->phone); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($branch->email): ?>
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900"><?php echo e($branch->email); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900"><?php echo e($branch->users->count()); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900"><?php echo e($branch->orders->count()); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <?php $__currentLoopData = $branch->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition duration-200">
                                <div class="flex-shrink-0 h-10 w-10 bg-[#203363] rounded-full flex items-center justify-center">
                                    <span class="text-white font-semibold"><?php echo e(substr($user->name, 0, 1)); ?></span>
                                </div>
                                <div class="ml-3">
                                    <p class="text-sm font-medium text-gray-900"><?php echo e($user->name); ?></p>
                                    <p class="text-xs text-gray-500"><?php echo e($user->role ?? 'Usuario'); ?></p>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Desktop\laravel\repo\restaurant_app\resources\views/branches/show.blade.php ENDPATH**/ ?>