    ...
    <input type="number" id="ventas-tarjeta-closure" class="form-control"
        value="<?php echo e($totalSalesCard ?? 0); ?>" step="0.01">
                            ...
                            <div class="form-actions">
                                ...
                                <button type="button" class="btn btn-primary" onclick="saveClosureClosure()">
...
<!-- Input oculto para el ID de caja chica -->
<input type="hidden" id="petty_cash_id_closure"><?php /**PATH C:\Users\HP\Desktop\laravel\repo\restaurant_app\resources\views/petty_cash/modal-content.blade.php ENDPATH**/ ?>