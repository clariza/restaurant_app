            ...
            <div class="grid grid-cols-12 p-4 border-b hover:bg-gray-50 items-center text-sm">
                ...
                <div class="col-span-3 md:col-span-2">
                    <span class="px-2 py-1 rounded-full text-xs <?php echo e($typeColor); ?>">
                        <?php echo e($isProforma ? 'Proforma' : ($record->order_type === 'Comer aquí' ? 'Para la Mesa' : $record->order_type)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Proyecto Clarisa\restaurant_app\resources\views/orders/index.blade.php ENDPATH**/ ?>