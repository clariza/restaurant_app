    ...
    <select name="branch_id" onchange="this.form.submit()"
        ...
        <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($branch->id); ?>"
                <?php echo e($branch->id == $branchId ? 'selected' : ''); ?>>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    data-stock-unit="<?php echo e($item->stock_unit); ?>">
                        ...
                        <span class="font-bold <?php echo e($item->branch_stock < $item->branch_min_stock 
                        ? 'text-red-600' 
                        : ($item->branch_stock == 0 ? 'text-red-700' : 'text-[#203363]')); ?>">
                        <?php echo e($item->branch_stock); ?> 
                        <?php echo e($item->stock_type == 'discrete' 
                        ? ($item->stock_unit ?? 'unid.') 
                        : ($item->stock_unit ?? 'gr/ml')); ?>

                    </span>
                    <?php if($item->branch_stock == 0): ?>
                        <span class="text-xs text-red-700 block font-semibold">(Sin stock)</span>
                    <?php elseif($item->branch_stock < $item->branch_min_stock): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\laravel_clary\restaurant_app\resources\views/inventory/index.blade.php ENDPATH**/ ?>