            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ${expensesData.map(expense => `
                    <tr class="hover:bg-gray-50 transition duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Bs. ${parseFloat(expense.amount).toFixed(2)}</td>
...
<script src="<?php echo e(asset('js/petty-cash-modal.js')); ?>"></script> <?php /**PATH C:\Users\HP\Desktop\laravel\repo\restaurant_app\resources\views/layouts/order-details.blade.php ENDPATH**/ ?>