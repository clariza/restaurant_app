            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-gray-900 font-semibold text-lg"><?php echo e($client->full_name); ?></p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 font-mono"><?php echo e($client->document_number ?: 'No especificado'); ?></p>
                    </div>
                    <div>
                ...
                <div class="space-y-3">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900"><?php echo e($client->phone ?: 'No especificado'); ?></p>
                        </div>
                    </div>
                    <div class="flex items-center">
                        <div class="w-10 h-10 bg-[#203363] rounded-full flex items-center justify-center mr-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900"><?php echo e($client->email ?: 'No especificado'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <p class="text-gray-900"><?php echo e($client->birthdays ? $client->birthdays->format('d/m/Y') : 'No especificada'); ?></p>
                    </div>
                    <div>
                        <label class="text-sm font-medium text-gray-500">Ciudad</label>
                        <p class="text-gray-900"><?php echo e($client->city ?: 'No especificada'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        ...
                        <span class="text-sm font-semibold text-gray-900">
                            <?php echo e($client->updated_at->format('d/m/Y')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Desktop\laravel\repo\restaurant_app\resources\views/clients/show.blade.php ENDPATH**/ ?>