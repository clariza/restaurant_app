...
<div class="container mx-auto p-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="<?php echo e(route('deliveries.create')); ?>" 
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <?php echo e($service->description ?? 'N/A'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <!-- Botón Editar -->
                                <a href="<?php echo e(route('deliveries.edit', $service->id)); ?>" 
                                   class="text-[var(--primary-color)] hover:text-[var(--primary-light)] inline-flex items-center">
                                    <i class="fas fa-edit mr-1"></i> Editar
                                </a>
                                
                                <!-- Formulario Eliminar -->
                                <form action="<?php echo e(route('deliveries.destroy', $service->id)); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\laravel_clary\restaurant_app\resources\views/deliveries/index.blade.php ENDPATH**/ ?>