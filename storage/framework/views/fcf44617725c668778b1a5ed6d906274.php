        ...
        <div class="detail-header">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="subtitle">
                        <i class="fas fa-calendar mr-2"></i><?php echo e(\Carbon\Carbon::parse($pettyCash->date)->format('d/m/Y')); ?>

                        <span class="mx-2">|</span>
                        <i class="fas fa-user mr-2"></i><?php echo e($pettyCash->user->name ?? 'Usuario no disponible'); ?>

                    </div>
                </div>
                <span class="status-badge <?php echo e($pettyCash->status == 'open' ? 'open' : 'closed'); ?>">
                    <i class="fas fa-circle mr-1"></i><?php echo e(ucfirst($pettyCash->status)); ?>
        ...
        <div class="detail-body">
            ...
            <div class="summary-grid">
                <div class="summary-box sales">
                    ...
                    <div class="amount">Bs. <?php echo e(number_format($pettyCash->total_sales_cash, 2)); ?></div>
                </div>
                ...
                <div class="summary-box qr">
                    ...
                    <div class="amount">Bs. <?php echo e(number_format($pettyCash->total_sales_qr, 2)); ?></div>
                </div>
                ...
                <div class="summary-box card">
                    ...
                    <div class="amount">Bs. <?php echo e(number_format($pettyCash->total_sales_card, 2)); ?></div>
                </div>
                ...
                <div class="summary-box expenses">
                    ...
                    <div class="amount">Bs. <?php echo e(number_format($pettyCash->total_expenses, 2)); ?></div>
                </div>
                ...
                <div class="summary-box balance">
                    ...
                    <div class="amount">Bs. <?php echo e(number_format($pettyCash->total_general, 2)); ?></div>
                </div>
            </div>
                ...
                <div class="comparison-row">
                    ...
                    <div class="comparison-values">
                        ...
                        <span class="difference <?php echo e(abs($diffCash) < 0.01 ? 'neutral' : ($diffCash > 0 ? 'positive' : 'negative')); ?>">
                            <?php echo e($diffCash > 0 ? '+' : ''); ?>Bs. <?php echo e(number_format($diffCash, 2)); ?>
            ...
            <div class="info-section">
                ...
                <div class="info-row">
                    <span class="info-label">
                        <i class="fas fa-clock"></i>Duración de Caja
                    </span>
                    <span class="info-value">
                        <?php echo e(\Carbon\Carbon::parse($pettyCash->date)->diffForHumans(\Carbon\Carbon::parse($pettyCash->closed_at), true)); ?>
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">#<?php echo e(str_pad($pettyCash->id, 6, '0', STR_PAD_LEFT)); ?></span>
                </div>
                ...
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo e($pettyCash->sales()->count()); ?> ventas registradas</span>
                </div>
                ...
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo e($pettyCash->expenses()->count()); ?> gastos registrados</span>
                </div>

                <?php if($pettyCash->notes): ?>
                <div class="info-row">
                    <span class="info-label">
                        <i class="fas fa-sticky-note"></i>Notas
                    </span>
                    <span class="info-value"><?php echo e($pettyCash->notes); ?></span>
                </div>
                <?php endif; ?>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><strong><?php echo e($expense->expense_name); ?></strong></td>
                            ...
                            <td class="text-right" style="color: var(--danger-color); font-weight: 600;">
                                Bs. <?php echo e(number_format($expense->amount, 2)); ?>
                        ...
                        <tr style="background-color: #f8f9fa; font-weight: 700;">
                            ...
                            <td class="text-right" style="color: var(--danger-color);">
                                Bs. <?php echo e(number_format($pettyCash->expenses()->sum('amount'), 2)); ?>
            ...
            <div class="action-buttons">
                <a href="<?php echo e(route('petty-cash.index')); ?>" class="btn btn-secondary">
                    <i class="fas fa-arrow-left"></i>
                    Volver al Listado
                </a>
                
                <a href="<?php echo e(route('petty-cash.print', $pettyCash)); ?>" class="btn btn-primary" target="_blank">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Desktop\laravel\repo\restaurant_app\resources\views/petty_cash/show.blade.php ENDPATH**/ ?>