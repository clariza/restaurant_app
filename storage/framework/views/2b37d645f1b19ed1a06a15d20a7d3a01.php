            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-<?php echo e(($isAdmin ?? false) && !empty($branches) ? '5' : '4'); ?> gap-4">
                ...
                <div>
                    ...
                    <select name="type"
                        ...
                        <option value="Comer aquí" <?php echo e(request('type') == 'Comer aquí' ? 'selected' : ''); ?>>Para la Mesa</option>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $orders->merge($proformas)->sortByDesc('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="hidden md:grid md:grid-cols-12 px-4 py-3 border-b hover:bg-gray-50 items-center text-sm">
                ...
                <div class="col-span-2">
                    <span class="inline-block px-2 py-1 rounded-full text-xs <?php echo e($typeColor); ?> whitespace-nowrap">
                        <?php echo e($typeLabel); ?><?php echo e($tableLabel); ?>
            ...
            <div class="grid grid-cols-12 px-4 py-3 border-b hover:bg-gray-50 items-center text-sm md:hidden">
                ...
                <div class="col-span-3 font-medium">
                    <div class="flex items-center gap-1 min-w-0">
                        <span class="inline-flex w-5 h-5 rounded-full <?php echo e($badgeColor); ?> text-white text-xs items-center justify-center flex-shrink-0">
                            <?php echo e($isProforma ? 'P' : 'O'); ?>
                ...
                <div class="col-span-4">
                    <div class="text-xs"><?php echo e($record->created_at->format('d/m/Y')); ?></div>
                    <div class="text-xs text-gray-500"><?php echo e($record->created_at->format('H:i')); ?></div>
                </div>
                
                <div class="col-span-3">
                    <span class="inline-block px-1 py-0.5 rounded-full text-xs <?php echo e($typeColor); ?>">
