...
{{-- ✅ ELIMINADO: #petty-cash-modal ya no existe aquí.
     El modal unificado (#unified-petty-cash-modal) vive en petty-cash-index.blade.php
     y debe estar disponible en el layout global o incluido antes de estos scripts. --}}
...
{{-- petty-cash-modal.js ya no es necesario aquí: la lógica vive en el modal unificado --}}
