{{-- ✅ MODAL DE CIERRE DE CAJA CHICA - ESTRUCTURA COMPLETA --}}
...
<div class="closure-internal-modal">
    @if($openPettyCash)
        ...
        <div class="closure-header">
            ...
            <button type="button" onclick="closeInternalModalClosure()" class="closure-close-btn" aria-label="Cerrar modal">
                            ...
                            <div class="table-container">
                                <table class="denominations-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="text-left">
                                                <strong>${{ number_format($denominacion, 2) }}</strong>
                                            </td>
                            ...
                            <div class="form-grid">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" 
                                           ...
                                           class="form-control form-control-highlight"
                                           value="0" 
                                           step="0.01"
                                           readonly
                                           tabindex="-1">
                                ...
                                <div class="form-actions">
                                    ...
                                    <button type="button" 
                                            class="btn btn-primary btn-save-closure" 
                                            onclick="saveClosureClosure({{ $openPettyCash->id }})">
