...
@if($openPettyCash)
    ...
    <input type="hidden" id="petty_cash_id_closure" name="petty_cash_id_closure" value="{{ $openPettyCash->id }}">
                        ...
                        <div class="section-container">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-actions">
                                    ...
                                    <button type="button" class="btn btn-primary" onclick="saveClosureClosure({{ $openPettyCash->id }})">
...
@else
    {{-- ⚠️ Mensaje cuando no hay caja abierta --}}
    <div class="closure-internal-content">
        <div class="closure-scroll-content">
            ...
            <div style="text-align: center; margin-top: 2rem;">
                <button onclick="window.location.href='{{ route('petty-cash.create') }}'" class="btn btn-primary">
