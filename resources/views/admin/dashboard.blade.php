...
@section('content')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-12 pt-8"> <!-- Agregado padding superior (pt-8) -->
    ...
    <script>
        ...
        const salesChartData = {
            labels: @json($labels), // Etiquetas (meses)
            datasets: [{
                label: 'Total de Ventas',
                data: @json($data), // Datos (totales de ventas)
        ...
        const salesTypeChartData = {
            labels: @json($typeLabels), // Etiquetas (tipos de venta)
            datasets: [{
                label: 'Ventas',
                data: @json($typeData), // Datos (totales de ventas por tipo)
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(75, 192, 192, 0.2)',
