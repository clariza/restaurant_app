...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadRecentMovements(itemId) {
        fetch(`/inventory/${itemId}/movements`)
            ...
            .then(data => {
                ...
                data.forEach(movement => {
                    ...
                    const movementTypeClass = movement.movement_type === 'addition' ? 'text-green-600' : 'text-red-600';
                    ...
                    row.innerHTML = `
                        ...
                        <td class="text-right py-2 ${movementTypeClass} font-medium">
                ...
                tbody.innerHTML = `
                    <tr>
                        <td colspan="4" class="py-4 text-center text-red-500">
                            <i class="fas fa-exclamation-triangle mr-2"></i>Error al cargar movimientos
                        </td>
                    </tr>
                `;
            });
