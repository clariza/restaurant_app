                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="ciudad" id="ciudad" value="{{ old('ciudad', $branch->ciudad) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="departamento" id="departamento" value="{{ old('departamento', $branch->departamento) }}"
