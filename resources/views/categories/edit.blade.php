...
<div class="container mx-auto p-6">
    ...
    <form action="{{ route('categories.update', $category) }}" method="POST" class="bg-white rounded-lg shadow-md p-6">
        @csrf
        @method('PUT')
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="icon" id="icon" value="{{ $category->icon }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
        </div>
