    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <table class="min-w-full">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-6 py-4 text-[var(--table-data-color)]">{{ $categoria->name }}</td>
                    <td class="px-6 py-4 text-[var(--table-data-color)]">{{ $categoria->icon }}</td>
                    <td class="px-6 py-4">
                        <!-- Icono de Editar -->
                        <a href="{{ route('categories.edit', $categoria->id) }}" class="text-[var(--primary-color)] hover:text-[var(--secondary-color)] mr-2">
